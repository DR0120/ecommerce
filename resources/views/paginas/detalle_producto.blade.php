        ...
        <div class="row">
          <div class="col-12 col-sm-6">
            ...
            <div class="col-12" align="center" id="imgPrincipal">
              <img src="/inventario/img/{{$producto['imagen']}}" alt="Product Image" height="500" width="500">
            </div>
          ...
          <div class="col-12 col-sm-6">
            ...
            <div class="col-3">
              <input class="form-control input-group" value="" type="number">
            </div>

            <div class="mt-4">
              <div class="btn btn-primary btn-lg btn-flat" onclick="añadirCarrito({{$producto->id}})">
...
@section('js')
  <script>
    function cambiarImagen(imagen){
      console.log(imagen);
      document.getElementById('imgPrincipal').innerHTML = '<img src="/inventario/img/'+imagen+'" alt="Product Image" height="500" width="500">'
    }  
    function añadirCarrito(id_producto){
      console.log('el producto '+ id_producto + ' a sido añadido a carrito');
    }
  </script>
@endsection